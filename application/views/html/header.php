...
<head>
    ...
    <link href="<?=base_url();?>assets/html/css/style2.css" rel="stylesheet">
	    ...
	    <div class="container">
	        <div class="row">
	            ...
	            <div class="col-lg-4 col-md-3 hidden-sm hidden-xs">
	            	<div class="well logo">
	            		<a href="<?=base_url();?>">
	            			 <img src="<?=base_url();?>assets/images/logonew.png" width="200px">
	            		</a>	            		
	            	</div>
	            </div>
	            <!-- End Logo -->
    ...
    <nav class="navbar navbar-dark bg-primary" role="navigation">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand visible-xs" href="<?=base_url();?>">Hiba Elekronik</a>
            </div>
